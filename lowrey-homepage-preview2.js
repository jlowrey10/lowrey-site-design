...
(function () {
  ...
  style.textContent += [
    ...
    '.lowrey-homepage-preview :is(h2,h3,h4){font-weight:400!important;letter-spacing:.015em!important}',
    '.lowrey-homepage-preview .md-hero [aria-level="3"],.lowrey-homepage-preview .md-hero [aria-level="3"] *{font-family:Questrial,Arial,sans-serif!important;letter-spacing:.015em!important}',
    '.lowrey-homepage-preview .md-hero .site-title{text-shadow:none!important}',
    '.lowrey-homepage-preview .md-team.layout10 :is(.agent-name,.agent-position,.single-intro,.main-btm,.share-links,.license-company),.lowrey-homepage-preview .md-team.layout10 :is(.agent-position,.single-intro,.main-btm,.share-links,.license-company) *{color:#142b3b!important;text-shadow:none!important}',
    '.lowrey-homepage-preview .md-team.layout10 :is(button,.button,.btn,.appointment-button),.lowrey-homepage-preview .md-team.layout10 :is(button,.button,.btn,.appointment-button) *{background:#071827!important;color:#fff!important}',
    '.lowrey-homepage-preview .md-cta.layout2 .media-content-v2{background:#071827!important;border:1px solid #ffffff30!important;box-shadow:0 24px 60px #0003!important}',
    '.lowrey-homepage-preview .md-cta.layout2 .content-mask{background:#071827!important}',
    '.lowrey-homepage-preview .md-cta.layout2 :is(.media-info,.site-title,.site-p),.lowrey-homepage-preview .md-cta.layout2 :is(.media-info,.site-title,.site-p) *{color:#fff!important;text-shadow:none!important}',
    '.lowrey-homepage-preview .md-cta.layout10 .text-content,.lowrey-homepage-preview .md-cta.layout10 .text-content *{color:#142b3b!important;text-shadow:none!important}',
    '.lowrey-homepage-preview .md-house :is(.title-wrap,.house-info),.lowrey-homepage-preview .md-house :is(.title-wrap,.house-info) *{color:#142b3b!important;text-shadow:none!important}',
    '.lowrey-homepage-preview .md-team.layout8 :is(.module-header,.agent-name,.agent-position),.lowrey-homepage-preview .md-team.layout8 .module-header *{color:#142b3b!important}',
    '.lowrey-homepage-preview .md-team-desc.layout7 .desc-intro *{color:#e0e8ec!important}',
    '.lowrey-homepage-preview .md-team-desc.layout7 .title-wrap *{color:#fff!important}',
    '.lowrey-homepage-preview .md-featured-area .featured-area-header *{color:#fff!important}',
    '.lowrey-homepage-preview .md-hero .title-text{perspective:1000px}',
    '.lowrey-homepage-preview .md-cta.layout10 .img-content{box-shadow:14px 18px 0 #071827,0 28px 55px #07182726;transition:box-shadow .3s ease}',
    '@media(hover:hover) and (prefers-reduced-motion:no-preference){.lowrey-homepage-preview .md-cta.layout10 .img-content:hover{box-shadow:20px 24px 0 #071827,0 36px 65px #07182733}}',
    '.lowrey-homepage-preview :is(a,button):focus-visible{outline:3px solid #2586ba!important;outline-offset:5px!important}'
  ].join('\n');
  function update() {
    frame = null;
    if (!hero) return;
